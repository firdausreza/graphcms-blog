...
const PostCard = ({post}) => {
  return (
    <div className="bg-white shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8">
      ...
      <div className="block lg:flex items-center justify-start mb-8 w-full">
        <div className="flex items-center justify-center mb-4 w-full mr-8 lg:mb-0 lg:w-auto">
          <img 
      ...
      <p className="text-justify text-lg text-gray-700 font-normal mb-8">
        {post.excerpt}
      </p>
      <div className="">
        <Link href={`/post/${post.slug}`}>
